...
export const ARRIVAL_TEXT_HE = [
  ...
  "באוטובוס — קווים 2 / 4 / 6, לרדת בתחנה פומפדיתא / שדרות האמוראים. משם לגשת לבין בנין שדרות האמוראים 57-59, יש מעבר עם מדרגות; בסוף המעבר בצד ימין זה בניין 24. הסטודיו בחדר הכחול בחניה.",
].join("\n");
export const ARRIVAL_HTML_HE = `<div style="margin-top:16px;padding:14px 16px;background:#faf7f4;border-radius:10px;border:1px solid #e8ddd3">
  ...
  <p style="margin:0;color:#2d3d2b;font-size:13px;line-height:1.6"><strong>באוטובוס</strong> — קווים 2 / 4 / 6, לרדת בתחנה פומפדיתא / שדרות האמוראים. משם לגשת לבין בנין שדרות האמוראים 57-59, יש מעבר עם מדרגות; בסוף המעבר בצד ימין זה בניין 24. הסטודיו בחדר הכחול בחניה.</p>
</div>`;
