...
- מועדון קאשבק: כל לקוחה רשומה צוברת אוטומטית 5% מסכום כל הזמנה (השכרת סטודיו או הזמנת אביזרים) כקרדיט לחשבון שלה, לשימוש בהזמנה הבאה. הצבירה קורית לבד, אין קוד או הרשמה נפרדת — היתרה מוצגת בעמוד /account.
