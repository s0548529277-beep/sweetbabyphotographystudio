...
- מבצע בוקר: 3 שעות ב-240₪ בהתחלה ב-8:00/9:00/10:00 (מסתיים עד 13:00) — תלוי רק בשעת ההתחלה ובמשך, לא בסוג הצילום. quote_studio_price מחשבת את זה אוטומטית לפי השעה, אין צורך לשאול אם זה ניו-בורן כדי לתת את המחיר.
