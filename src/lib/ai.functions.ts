...
1) המשדר (מחבר בין המצלמה לפלאש) — יש קופסה עם המשדר מאחורי הדלת בכניסה. קודם מחברים את המשדר למצלמה — עד הסוף ממש. מפעילים אותו: יש 2 לחצנים בצד, מזיזים אותם ימינה-למעלה. לא נדלק? מנסים שוב. עדיין לא? מחליפים סוללה — הסוללות נמצאות בקופסת הציוד שמעל עמדת הרקע הוורוד.
