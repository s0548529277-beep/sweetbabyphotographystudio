      ...
      <section className="container-page py-14 flex-1">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-muted-foreground max-w-2xl mb-10">
            {type === "booking"
              ? `עברי על הפרטים ולסיום השריון יש לשלם מקדמה של ₪${deposit} בלבד (בהעברה בנקאית/אשראי או Bit/PayBox עם אסמכתא). היתרה ₪${balance} תשולם ביום הצילום.`
            ...
            <aside className="space-y-4">
              <div className="glass-card rounded-3xl p-6 sticky top-24">
                ...
                <div className="mt-6 space-y-3">
                  {/* Card payment lives only on the receipt / deposit page. */}
                  ...
                  >
                    <span className="flex items-center gap-2">
                      ...
                      <span>{type === "booking" ? "העברה בנקאית / אשראי/ Bit" : "מזומן/ אשראי / העברה בנקאית / Bit"}</span>
                    </span>
