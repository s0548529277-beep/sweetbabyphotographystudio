...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "סוויט בייבי — כאן נולדת התמונה שתשאר איתך תמיד. סטודיו בוטיק בבית שמש עם 400+ אביזרים לצילומי ניוברן, השכרת סטודיו וסשן צילום עם מיכל סיבוני." },
      ...
      { name: "twitter:description", content: "סוויט בייבי — כאן נולדת התמונה שתשאר איתך תמיד. סטודיו בוטיק בבית שמש עם 400+ אביזרים לצילומי ניוברן, השכרת סטודיו וסשן צילום עם מיכל סיבוני." },
