...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "סוויט בייבי — ה,מונה הראשונה שלי כאן נולדת התמונה שתשאר איתך תמיד. סטודיו בוטיק בבית שמש עם 400+ אביזרים לצילומי ניוברן, השכרת סטודיו וסשן צילום עם מיכל סיבוני." },
      { property: "og:title", content: "סוויט בייבי —התמונה הראשונה שלי צילומים מתוקים מתחילים כאן" },
      { property: "og:description", content: "סוויט בייבי — ה,מונה הראשונה שלי כאן נולדת התמונה שתשאר איתך תמיד. סטודיו בוטיק בבית שמש עם 400+ אביזרים לצילומי ניוברן, השכרת סטודיו וסשן צילום עם מיכל סיבוני." },
      ...
      { name: "twitter:description", content: "סוויט בייבי — ה,מונה הראשונה שלי כאן נולדת התמונה שתשאר איתך תמיד. סטודיו בוטיק בבית שמש עם 400+ אביזרים לצילומי ניוברן, השכרת סטודיו וסשן צילום עם מיכל סיבוני." },
