...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "סוויט בייבי — התמונה הראשונה שלי · השכרת הסטודיו · מיכל סיבוני" },
      ...
      { property: "og:title", content: "סוויט בייבי — התמונה הראשונה שלי · השכרת הסטודיו · מיכל סיבוני" },
      ...
      { name: "twitter:title", content: "סוויט בייבי — התמונה הראשונה שלי · השכרת הסטודיו · מיכל סיבוני" },
