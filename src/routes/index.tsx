...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "סוויט בייבי —התמונה הראשונה שלי צילומים מתוקים מתחילים כאן" },
      { name: "description", content: "סוויט בייבי — התמונה הראשונה שלי  סטודיו בוטיק להשכרה בבית שמש עם 400+ אביזרים להשכרה לצילומי ניוברן חלאקה סמאש קיק ועוד, השכרת סטודיו וסשן צילום עם מיכל סיבוני" },
      { property: "og:title", content: "סוויט בייבי —התמונה הראשונה שלי צילומים מתוקים מתחילים כאן" },
      { property: "og:description", content: "סוויט בייבי — התמונה הראשונה שלי  סטודיו בוטיק להשכרה בבית שמש עם 400+ אביזרים להשכרה לצילומי ניוברן חלאקה סמאש קיק ועוד, השכרת סטודיו וסשן צילום עם מיכל סיבוני" },
      ...
      { name: "twitter:title", content: "סוויט בייבי —התמונה הראשונה שלי צילומים מתוקים מתחילים כאן" },
      { name: "twitter:description", content: "סוויט בייבי — התמונה הראשונה שלי  סטודיו בוטיק להשכרה בבית שמש עם 400+ אביזרים להשכרה לצילומי ניוברן חלאקה סמאש קיק ועוד, השכרת סטודיו וסשן צילום עם מיכל סיבוני" },
