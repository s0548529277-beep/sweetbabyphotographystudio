...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "סטודיו לצילום להשכרה סוויט בייבי — מיכל סיבוני" },
      { name: "description", content: "סטודיו לצילום להשכרה סוויט בייבי — התמונה הראשונה שלי.סטודיו בוטיק להשכרה בבית שמש השכרת אביזרים לצילום ניוברן חלאקה סמאש קיק ועוד, סשן צילום מיכל סיבוני" },
      { property: "og:title", content: "סטודיו לצילום להשכרה סוויט בייבי — מיכל סיבוני" },
      { property: "og:description", content: "סטודיו לצילום להשכרה סוויט בייבי — התמונה הראשונה שלי.סטודיו בוטיק להשכרה בבית שמש השכרת אביזרים לצילום ניוברן חלאקה סמאש קיק ועוד, סשן צילום מיכל סיבוני" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Sweetbaby" },
      { property: "og:locale", content: "he_IL" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "סטודיו לצילום להשכרה סוויט בייבי — מיכל סיבוני" },
      { name: "twitter:description", content: "סטודיו לצילום להשכרה סוויט בייבי — התמונה הראשונה שלי.סטודיו בוטיק להשכרה בבית שמש השכרת אביזרים לצילום ניוברן חלאקה סמאש קיק ועוד, סשן צילום מיכל סיבוני" },
