...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Sweetbaby — סטודיו בוטיק, צילומים והשכרת אביזרים בבית שמש" },
      { name: "twitter:description", content: "סטודיו בוטיק בבית שמש: השכרת חלל צילום, סשן צילום עם מיכל סיבוני וקטלוג של 400+ אביזרים מעוצבים לניוברן, גיל שנה, חלאקה ומשפחה." },
