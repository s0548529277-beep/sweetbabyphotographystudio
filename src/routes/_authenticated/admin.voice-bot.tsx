    ...
    <div dir="rtl" className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          קובע את הקול שבו הבוט הקולי (נועה) מדברת בשיחות טלפון נכנסות — נכנס לתוקף באופן מיידי, בלי
          דיפלוי. זה נוגע רק לבוט הטלפוני מבוסס Twilio שקיים בפרויקט הזה — אם יש לכם בוט טלפוני נפרד
          המחובר לימות המשיח, הוא לא נשלט מכאן (ראו AGENTS.md).
        </p>
      </div>
